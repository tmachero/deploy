...
(function ($) {
    ...
    $.fn.uploadFile = function (options) {
        ...
        var s = $.extend({
            ...
            dragDropStr: "<span><b>将文件拖拉至此处</b></span>",
            abortStr: "Abort",
            cancelStr: "Cancel",
            deletelStr: "Delete",
            doneStr: "Done",
        ...
        this.fCounter = 0; //上传失败
        this.sCounter = 0; //上传成功
        this.tCounter = 0; //所有上传
        var formGroup = "ajax-file-upload-" + (new Date().getTime());
        this.formGroup = formGroup;
        this.hide();
        this.errorLog = $("<div></div>"); //报告错误
        this.after(this.errorLog);
        this.responses = [];
        this.existingFileNames = [];
        if(!feature.formdata) //确认拖拽是否允许.
        {
            s.dragDrop = false;
        }
        if(!feature.formdata) {
        ...
        function createCutomInputFile(obj, group, s, uploadLabel) {
            ...
            fileInput.change(function () {
                ...
                form.addClass(group);
                if(feature.fileapi && feature.formdata) //使用HTML5支持并分发file上传
                {
                    form.removeClass(group); //停止提交.
            ...
            if(s.nestedForms) {
                ...
                if(navigator.appVersion.indexOf("MSIE ") != -1) //IE浏览器
                {
            ...
            var options = {
                ...
                beforeSubmit: function (formData, $form, options) {
                    ...
                    pd.cancel.click(function () {
                        ...
                        obj.selectedFiles -= fileArray.length; //减少选择文件的数量
                        updateFileCounter(s, obj);
                    });
                    return false;
                },
                beforeSend: function (xhr, o) {
                    ...
                    if(!feature.formdata) //frame基本推送
                    {
                        pd.progressbar.width('5%');
                    } else pd.progressbar.width('1%'); //为小文件进行调整
                },
